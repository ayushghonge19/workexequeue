...
Example: Instead of making a user wait for a "Welcome Email" to be sent during login, the system adds a send_email task to the queue. The Worker picks it up and processes it in the background, allowing the user to proceed immediately.
🛠️ Getting Started
...
Worker Service
    ...
    Supported Tasks:
        ...
        resize_image: Simulates image resizing logic.
...
📊 Observability
    ...
    Metrics: The worker exposes a simple metrics endpoint (default port 4000) at /metrics to track jobs_done and jobs_failed.
